...
transpose{T,S,UpLo,IsUnit}(A::Triangular{T,S,UpLo,IsUnit}) = Triangular(transpose(A.data), UpLo == :U ? 'L' : 'U', A.unitdiag)
ctranspose{T,S,UpLo,IsUnit}(A::Triangular{T,S,UpLo,IsUnit}) = Triangular(ctranspose(A.data), UpLo == :U ? 'L' : 'U', A.unitdiag)
transpose!{T,S,UpLo,IsUnit}(A::Triangular{T,S,UpLo,IsUnit}) = Triangular(copytri!(A.data, UpLo == :L ? 'L' : 'U'), UpLo == :U ? 'L' : 'U', IsUnit ? 'U' : 'N')
ctranspose!{T,S,UpLo,IsUnit}(A::Triangular{T,S,UpLo,IsUnit}) = Triangular(copytri!(A.data, UpLo == :L ? 'L' : 'U', true), UpLo == :U ? 'L' : 'U', IsUnit ? 'U' : 'N')
